...
./.venv/bin/python -m pip install -q --disable-pip-version-check "fastapi" "uvicorn[standard]" "httpx"
...
exec ./.venv/bin/python -m uvicorn app:app --host 0.0.0.0 --port "${PORT:-8799}"
